		...
		<div class="row">
			...
			<div class="col-md-6">
				<form class="text-center" action="add_to_review.php" method="POST">
					...
					<input type="text" name="review_text" class="form-control" placeholder="Add the review here..."><br>
					
					<input type="submit" value="Submit Review" class="btn btn-danger btn-lg">
					<!-- Skip button -->
					<a href="skip_review.php?product_id=<?php echo $product_id; ?>" class="btn btn-secondary btn-lg mt-2">Skip</a>
				</form>
			</div>
		</div>
	</body>
