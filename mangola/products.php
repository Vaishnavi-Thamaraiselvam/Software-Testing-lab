...
<body style="background-image: url('images/background2.jpg'); !important">
  ...
  <div class="container ">
    <h1 class="text-center font-80px margin-bottom50"> <b>Welcome <?php echo $_SESSION['name']; ?>, What’s tempting your taste buds today?</b></h1>
        ...
        <div class="row">
          ...
          <div class="col-md-12 bio-tab">
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="text-center"> <b>About Mango Vanam.com</b> </h1>
